...
from .models import CustomUser, Ministere, Policier, Commissaire, Commissariat, Ville, Region, District, Crime, Secteur, Quartier, Equipe_enquetrice

def commissaire_home(request):
